...
**EComm-CS** е модерен eCommerce проект, създаден като част от моето портфолио. Той демонстрира интеграция между **Next.js** (frontend) и **Strapi** (backend), с пълна функционалност за онлайн магазин.
